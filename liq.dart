...
List<String> inunit=['ml','centiliter','deciliter ','L'];
class Liquids extends StatefulWidget {
  const Liquids({super.key});

  @override
  State<Liquids> createState() => _LiquidsState();
}

class _LiquidsState extends State<Liquids> {
      ...
      body: Center(
        child: Column(
          children: [
            ...
            const Text('Enter the unit of the data entered:'),
            const SizedBox(height: 20,),
            UnitDropMenu(set: setFrom),
            const SizedBox(height: 20,),
            const Text('Enter the unint to change to:'),
            const SizedBox(height: 20,),
            ...
            Text(text+' '+inunit[to]),
            const SizedBox(height: 20,),
            Image.asset('assets/liquids.jpg')
